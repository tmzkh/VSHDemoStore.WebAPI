    ...
    Route::group([
        ...
        */
        Route::group([
            ...
            Route::put(
                '/',
                [UserInfoController::class, 'update']
            )
                ->name('update');

            Route::get(
                '/avatar',
                [AvatarController::class, 'index']
            )
                ->name('avatar.get');

            Route::post(
                '/avatar',
                [AvatarController::class, 'store']
            )
                ->name('avatar.update');
        });
        ...
        */
        Route::group([
            ...
            */
            ...
            /*
            |-------------------------------------------------------------------
            | Product asset management routes
            |-------------------------------------------------------------------
            */
            Route::group([
                'as' => 'product-assets.',
                ...
                Route::post(
                    '/{product}/assets',
                    [ProductAssetController::class, 'store']
                )
                    ->name('store');
            });
        });
    ...
    Route::group([
        ...
        */
        Route::group([
            ...
            Route::get(
                '/{product}/assets',
                [ProductAssetController::class, 'index']
            )
                ->name('store');
        });
